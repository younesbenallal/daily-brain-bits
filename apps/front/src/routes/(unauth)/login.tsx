...
function LoginPage() {
	...
	const callbackPath = new URLSearchParams(window.location.search).get("callbackUrl") || "/";
	const callbackURL = callbackPath.startsWith("http") ? callbackPath : `${window.location.origin}${callbackPath}`;
